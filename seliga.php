...
<html lang="PT-BR">
 ...
 <!-- END nav -->
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('http://ubes.org.br/ubesnovo/wp-content/uploads/2017/03/voto-aos-16-719x480.jpg ');" style="text-align:center" />
      <div class="overlay"></div>

      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">SE LIGA, 16</h1>
        ...
        <div class="col-md-7 wrap-about py-2 pr-md-4 ftco-animate">	
               ...
               <p>A campanha “Se Liga, 16” estimulava a juventude a participar das eleições presidenciais de 1989. Em tempos sem internet, em que a informação tinha poucos meios para circular, a movimentação da UBES conseguiu até emplacar vídeos em rede nacional de televisão. Dados de 1990 mostram mais de 2 milhões de eleitores com menos de 18 anos cadastrados no Tribunal Superior Eleitoral (TSE).
“Se Liga, 16” tem sido uma campanha permanente da entidade para conscientizar os jovens de seus direitos democráticos. O incentivo é para que o jovem tire seu título eleitoral e, principalmente, se informe, acompanhe e cobre os candidatos escolhidos. </p>
            <center>
              <img src=" https://www.globalframe.com.br/gf_base/empresas/MIGA/imagens/B6B2E5133E020DE9412B579ED1B01510DF01_foto%204%20manuela.jpg" style="width:65%" align="center">
              </center>			
