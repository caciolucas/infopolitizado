...
<html lang="pt-br">
    ...
    <div class="main p-4">
        <h3 class="display-4 text-dark" style="font-family:'Verdana';font-weight:300">Usuários</h3>
            ...
            <div class='row'>
                <div class="col-sm-12 col-lg-6">
                    <div class="p-4" style="width:100%;/* margin: auto; */">
                        <a href='..\php/register.php' class='btn btn-primary circle'><img src="..\open-iconic-master\svg\plus.svg" class='oi' alt="Novo Usuário"></a>
                    </div>    
                </div>
                <div class="col-sm-12 col-lg-6">
                    <div class="p-4">
                        <a href='listausuarios.php' class='btn btn-secondary circle'><img src="..\open-iconic-master\svg\list.svg" class='oi' alt="Editar categoria"></a>
                    </div>    
                </div>
            </div>
        </div>
