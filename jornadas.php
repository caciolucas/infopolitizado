...
<html lang="PT-BR">
 ...
 <!-- END nav -->
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('https://media.gazetadopovo.com.br/2016/06/33994218ba0c8f3d92a152e224ba9c2d-gpMedium.jpg');" style="text-align:center" />
      <div class="overlay"></div>

      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">JORNADAS DE JUNHO </h1>
 ...
 <a data-toggle="collapse" href="#collapseMilitar" role="button" aria-expanded="false" aria-controls="collapseMilitar">Ler mais</a></p>
              <div class="collapse" id="collapseMilitar">
                      <p>A tática de repressão utilizada pela polícia não funcionou e fez o movimento crescer. Cada vez mais e mais pessoas passaram a ir às ruas e as bandeiras dos protestos se diversificaram: passou-se a exigir não só a melhoria nos transportes públicos, mas dos serviços públicos em geral, especialmente educação e saúde. </p>
            <center>
              <img src="https://www.redebrasilatual.com.br/wp-content/uploads/2019/05/junho-13.jpg" style="width:65%" align="center">
              </center>	
