...
<html lang="PT-BR">
	        ...
	        <ul class="navbar-nav ml-auto">
	        	 <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <a class="dropdown-item" href="republicaoligarquica">República Oligárquicas</a>
 ...
 <!-- END nav -->
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('https://i0.wp.com/trabalhosparaescola.com.br/wp-content/uploads/2018/06/historia-do-brasil-presidentes-da-fase-da-redemocratizacao.jpg?fit=696%2C317&ssl=1');" style="text-align:center" />
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php"> Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span> Sobre nós <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
