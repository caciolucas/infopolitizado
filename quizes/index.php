...
<html lang="pt-br">
    ...
    <div class="main p-4">
        <h3 class="display-4 text-dark" style="font-family:'Verdana';font-weight:300">QUIZES</h3>
            ...
            <div class='row'>
                <div class="col-sm-12 col-lg-4">
                    <div class="p-4" style="width:100%;/* margin: auto; */">
                        <a href='cadastroquiz.php' class='btn btn-primary circle'><img src="..\open-iconic-master\svg\plus.svg" class='oi' alt="Novo quiz"></a>
                    </div>    
                </div>
                <div class="col-sm-12 col-lg-4">
                    <div class="p-4">
                        <a href='editaquiz.php' class='btn btn-secondary circle'><img src="..\open-iconic-master\svg\pencil.svg" class='oi' style="margin-top: 25%;margin-left: 33%;" alt="Editar quiz"></a>
                    </div>    
                </div>
                <div class="col-sm-12 col-lg-4">
                    <div class="p-4">
                        <a href='listaquizes.php' class='btn btn-success circle'><img src="..\open-iconic-master\svg\list.svg" class='oi' alt="Listar quizes"></a>
                    </div>    
                </div>
            </div>
        </div>
    </div>
    <center><a class="btn btn-success m-1" href='..\userpage'>Voltar</a></center>
    <?php endif ?>
</body>