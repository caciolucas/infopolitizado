    ...
    <div class="main p-4">
        ...
        <form method='post' action='editapergunta.php'>
            <div class="form-group">
                ...
                <textarea disabled class="form-control" name='enunciado' rows="3" placeholder="Escreva aqui o enunciado da pergunta"><?php echo $pergunta['enunciado'] ?></textarea>
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend" style='text-align:center'>
                    <span class="input-group-text"  id="basic-addon1">A)</span>
                </div>
                <input disabled type="text" value='<?php echo $pergunta['alternativaA'] ?>' name="alternativaA" class="form-control" placeholder="Alternativa A" >
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend" style='text-align:center'>
                    <span class="input-group-text"  id="basic-addon1">B)</span>
                </div>
                <input disabled type="text"  value='<?php echo $pergunta['alternativaB'] ?>'name="alternativaB" class="form-control" placeholder="Alternativa B" >
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend" style='text-align:center'>
                    <span class="input-group-text"  id="basic-addon1">C)</span>
                </div>
                <input disabled type="text"  value='<?php echo $pergunta['alternativaC'] ?>'name="alternativaC"  class="form-control" placeholder="Alternativa C" >
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend" style='text-align:center'>
                    <span class="input-group-text"  id="basic-addon1">D)</span>
                </div>
                <input disabled type="text" value='<?php echo $pergunta['alternativaD'] ?>' name="alternativaD" class="form-control" placeholder="Alternativa D" >
            </div>
            <div>
                <center>
                <p class="text-dark" style="font-family:'Work Sans';font-weight:500">Alternativa Correta</p>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" <?php if($pergunta['resposta_certa']=='a'):?> checked <?php endif ?> type="radio" name="alt_correta"  value="a">
                    <label class="form-check-label" for="dificuldade1">A)</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" <?php if($pergunta['resposta_certa']=='b'):?> checked <?php endif ?> type="radio" name="alt_correta"  value="b">
                    <label class="form-check-label" for="dificuldade1">B)</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" <?php if($pergunta['resposta_certa']=='c'):?> checked <?php endif ?> type="radio" name="alt_correta"  value="c">
                    <label class="form-check-label" for="dificuldade1">C)</label>
                </div>
                <div class="form-check form-check-inline">
                    <input disabled class="form-check-input" <?php if($pergunta['resposta_certa']=='d'):?> checked <?php endif ?> type="radio" name="alt_correta"  value="d">
