...
<html lang="pt-br">
    ...
    <div class="main p-4">
        <h3 class="display-4 text-dark" style="font-family:'Verdana';font-weight:300">PERGUNTAS</h3>
            ...
            <div class='row'>
                <div class="col-sm-12 col-lg-6">
                    <div class="p-4" style="width:100%;/* margin: auto; */">
                        <a href='cadastropergunta.php' class='btn btn-primary circle'><img src="../open-iconic-master\svg\plus.svg" class='oi' alt="Nova Pergunta"></a>
                    </div>    
                </div>
                
                <div class="col-sm-12 col-lg-6">
                    <div class="p-4">
                        <a href='listaperguntas.php' class='btn btn-success circle'><img src="../open-iconic-master\svg\list.svg" class='oi' alt="Listar Perguntas"></a>
                    </div>    
                </div>
            </div>
        </div>
