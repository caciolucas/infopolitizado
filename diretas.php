      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">DIRETAS JÁ!</h1>
        ...
        <div class="col-md-7 wrap-about py-2 pr-md-4 ftco-animate">	
               ...
               <p>Diretas já, foi um movimento político democrático com grande participação popular que ocorreu no ano de 1984, este movimento era favorável e apoiava a emenda do deputado Dante de Oliveira que restabelecia as eleições diretas para presidente da República no Brasil. Durante o movimento ocorreram diversas manifestações populares em muitas cidades brasileiras, estes eventos populares contaram com a participação de milhares de brasileiros. O movimento das Diretas Já, contou com o apoio de diversos políticos da época, artistas, jogadores de futebol, cantores, religiosos, etc. Em 25 de abril de 1984, a emenda constitucional das eleições diretas foi colocada em votação, porém, para a desilusão do povo brasileiro, ela não foi aprovada. As eleições diretas para presidente do Brasil só ocorreriam em 1989, após ser estabelecida na Constituição de 1988. 
               <a data-toggle="collapse" href="#collapseMilitar" role="button" aria-expanded="false" aria-controls="collapseMilitar">Ler mais</a></p>
</p>
            <center>
              <img src="https://www.ocafezinho.com/wp-content/uploads/2017/05/uau.jpg" style="width:65%" align="center">
              </center>			
              <div class="collapse" id="collapseMilitar">
                  <br>
            <center>
              <img src="https://www.redebrasilatual.com.br/wp-content/uploads/2019/05/diretas.jpg" style="width:65%" align="center">
              </center>	
